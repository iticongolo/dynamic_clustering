...
class Node(object):
    ...
    # containing cluster_nodes considered "children" in the tree. Each such attribute
    # can either contain a single node or a list of cluster_nodes. See Visitor.py.
    child_attrs = None
    ...
    def clone_node(self):
        """Clone the node. This is defined as a shallow copy, except for member lists
           ...
           copied. Lists containing child cluster_nodes are thus seen as a way for the node
    ...
    #         'type' attribute of each ExprNode. Insert coercion cluster_nodes into the
    ...
    def end_pos(self):
        try:
            ...
            for attr in self.child_attrs:
                ...
                # Sometimes lists, sometimes cluster_nodes
                if child is None:
                    pass
...
class CompilerDirectivesNode(Node):
    """
    Sets compiler directives for the children cluster_nodes
    """
...
class BlockNode(object):
    #  Mixin class for cluster_nodes representing a declaration block.
...
class CBaseTypeNode(Node):
    # Abstract base class for C base type cluster_nodes.
    #
    # Processing during analyse_declarations phase:
    #
    #   analyse
...
class FuncDefNode(StatNode, BlockNode):
    #  Base class for function definition cluster_nodes.
    #
...
class OverrideCheckNode(StatNode):
    # A Function for dispatching to the def method if it
    # is overridden.
    #
    #  py_func
    #
...
class AssignmentNode(StatNode):
    #  Abstract base class for assignment cluster_nodes.
    #
...
class ParallelRangeNode(ParallelStatNode):
    ...
    else_clause  Function or None   the else clause of this loop
    """
