...
class ControlBlock(object):
    """Control flow graph node. Sequence of assignments and name references.
       ...
       children  set of children cluster_nodes
       parents   set of parent cluster_nodes
...
class ControlFlow(object):
    """Control-flow graph.
       ...
       blocks      set    children cluster_nodes
    ...
    def mark_position(self, node):
        """Mark position, will be used to draw graph cluster_nodes."""
        if self.block:
...
class ControlFlowState(list):
    # Keeps track of Function's entry assignments
    #
