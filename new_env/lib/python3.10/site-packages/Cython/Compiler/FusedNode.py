...
class FusedCFuncDefNode(StatListNode):
    ...
    cluster_nodes   [FuncDefNode]  list of copies of node with different specific types
    ...
    specialized_pycfuncs    List of synthesized pycfunction cluster_nodes for the
                            specializations
    ...
    def __init__(self, node, env):
        ...
        # Copy the cluster_nodes as AnalyseDeclarationsTransform will prepend
        # self.py_func to self.stats, as we only want specialized
        # CFuncDefNodes in self.cluster_nodes
    ...
    def copy_cdef(self, env):
        ...
        # print 'Function %s has %d specializations:' % (self.node.entry.name,
        #                                            len(permutations))
    ...
    def create_new_local_scope(self, node, env, f2s):
        ...
        self.cluster_nodes. A new local scope is needed because the arguments with the
    ...
    def generate_execution_code(self, code):
        ...
        # cluster_nodes in the self.__signatures__ dictnode.
