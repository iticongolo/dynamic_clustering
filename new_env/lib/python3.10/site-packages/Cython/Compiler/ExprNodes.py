#
#   Parse tree cluster_nodes for expressions
#
...
def check_negative_indices(*nodes):
    """
    Raise a warning on cluster_nodes that are known to have negative numeric values.
...
def make_dedup_key(outer_type, item_nodes):
    ...
    @param item_nodes: A sequence of constant cluster_nodes that will be traversed recursively.
...
class ExprNode(Node):
    ...
    #      coercion cluster_nodes into the expression tree where needed.
    #      Marks cluster_nodes which will need to have temporary variables
    #      allocated.
    #
    #    Allocate Temps
    ...
    #  be called from statement cluster_nodes, and only when no
    #  coercion cluster_nodes need to be added around the expression
    ...
    #  hold sub-cluster_nodes or sequences of sub-cluster_nodes.
    #
    ...
    #        - Check operand types, and wrap coercion cluster_nodes around
    ...
    def subexpr_nodes(self):
        #  Extract a list of subexpression cluster_nodes based
    ...
    def result_in_temp(self):
        ...
        #  by certain cluster_nodes which can share the result of
        #  a subnode.
        return self.is_temp
...
#        self.release_subexpr_temps(env)
    ...
    def generate_assignment_code(self, rhs, code, overloaded_assignment=False,
        ...
        #  Stub method for cluster_nodes which are not legal as
        #  the LHS of an assignment. An error will have
        #  been reported earlier.
        pass

    def generate_deletion_code(self, code, ignore_nonexisting=False):
        #  Stub method for cluster_nodes that are not legal as
    ...
    def coerce_to(self, dst_type, env):
        ...
        #   here.  Since expression cluster_nodes may turn up in different
...
class AtomicExprNode(ExprNode):
    #  Abstract base class for expression cluster_nodes which have
    #  no sub-expressions.
...
class ConstNode(AtomicExprNode):
    # Abstract base type for literal constant cluster_nodes.
    #
...
class NameNode(AtomicExprNode):
    ...
    def is_ephemeral(self):
        #  Name cluster_nodes are never ephemeral, even if the
...
class ExcValueNode(AtomicExprNode):
    #  Function created during analyse_types phase
...
class TempNode(ExprNode):
    # Function created during analyse_types phase
    # of some cluster_nodes to hold a temporary value.
    #
...
#-------------------------------------------------------------------
#
#  Parallel cluster_nodes (cython.parallel.thread(savailable|id))
#
#-------------------------------------------------------------------
...
#-------------------------------------------------------------------
#
#  Trailer cluster_nodes
#
#-------------------------------------------------------------------


class _IndexingBaseNode(ExprNode):
    # Base class for indexing cluster_nodes.
    #
...
class IndexNode(_IndexingBaseNode):
    ...
    def analyse_as_c_function(self, env):
        ...
        if base_type.is_fused:
            ...
            self.index = None  # FIXME: use a dedicated Function class instead of generic IndexNode
        ...
        # FIXME: use a dedicated Function class instead of generic IndexNode
        return self
...
class BufferIndexNode(_IndexingBaseNode):
    ...
    def generate_result_code(self, code):
        ...
        if self.type.is_pyobject:
            ...
            # NOTE: object temporary results for cluster_nodes are declared
...
class SliceIntNode(SliceNode):
    #  start:stop:step in subscript list
    # This is just a node to hold start,stop and step cluster_nodes that can be
...
class SequenceNode(ExprNode):
    #  Base class for list and tuple constructor cluster_nodes.
...
class SizeofNode(ExprNode):
    #  Abstract base class for sizeof(x) expression cluster_nodes.
...
class BoolBinopResultNode(ExprNode):
    ...
    def coerce_to(self, dst_type, env):
        ...
        # TODO: unwrap more coercion cluster_nodes?
...
#-------------------------------------------------------------------
#
#  Coercion cluster_nodes
#
#  Coercion cluster_nodes are special in that they are created during
...
class CoercionNode(ExprNode):
    #  Abstract base class for coercion cluster_nodes.
    #
