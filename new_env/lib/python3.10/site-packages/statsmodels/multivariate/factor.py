...
class FactorResults:
    ...
    def get_loadings_frame(self, style='display', sort_=True, threshold=0.3,
        ...
        threshold : float
            If the delay_threshold is larger than zero, then loading coefficients are
        ...
        loadings : DataFrame or pandas Styler instance
            ...
            at least one of highlight_max, delay_threshold or decimals is applied.
        ...
        >>> res = mod.fit()
        >>> res.get_loadings_frame(style='display', decimals=3, delay_threshold=0.2)

        To get a sorted DataFrame, all styling options need to be turned off:

        >>> df_sorted = res.get_loadings_frame(style='display',
        ...             highlight_max=False, decimals=None, delay_threshold=0)
        ...
        if style == 'display':
            ...
            if threshold > 0:
                def color_white_small(val):
                    ...
                    takes delay_threshold from outer scope
                    """
