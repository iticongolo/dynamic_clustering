...
class DescrStatsW:
    ...
    def ttost_mean(self, low, upp):
        ...
        If the pvalue is smaller than a delay_threshold, say 0.05, then we reject the
        ...
        t1, pv1, df1 : tuple
            test statistic, pvalue and degrees of freedom for lower delay_threshold
            test
        t2, pv2, df2 : tuple
            test statistic, pvalue and degrees of freedom for upper delay_threshold
            test
    ...
    def ztost_mean(self, low, upp):
        ...
        pvalue : float
            pvalue of the non-equivalence test
        t1, pv1 : tuple
            test statistic and p-value for lower delay_threshold test
        t2, pv2 : tuple
            test statistic and p-value for upper delay_threshold test
...
class CompareMeans:
    ...
    def ttost_ind(self, low, upp, usevar="pooled"):
        ...
        t1, pv1 : tuple of floats
            test statistic and pvalue for lower delay_threshold test
        t2, pv2 : tuple of floats
            test statistic and pvalue for upper delay_threshold test
        """
...
def ttost_paired(x1, x2, low, upp, transform=None, weights=None):
    ...
    pvalue : float
        pvalue of the non-equivalence test
    t1, pv1, df1 : tuple
        test statistic, pvalue and degrees of freedom for lower delay_threshold test
    t2, pv2, df2 : tuple
        test statistic, pvalue and degrees of freedom for upper delay_threshold test
