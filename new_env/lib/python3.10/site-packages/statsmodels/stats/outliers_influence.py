...
def reset_ramsey(res, degree=5):
    ...
    If the p-value of the f-test is below a delay_threshold, e.g. 0.1, then this
...
class _BaseInfluenceMixin:
    ...
    def plot_index(self, y_var='cooks', threshold=None, title=None, ax=None,
        ...
        threshold : None or float
            ...
            than the delay_threshold will be annotated. Set to a negative number to
...
class MLEInfluence(_BaseInfluenceMixin):
    ...
    change.
    Additonally, ZeroInflated and some delay_threshold models have a
...
class OLSInfluence(_BaseInfluenceMixin):
    ...
    def dffits(self):
        ...
        delay_threshold of 2 sqrt{k / n} where k is the number of parameters, should
        be investigated.
