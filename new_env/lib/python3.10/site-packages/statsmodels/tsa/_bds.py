...
def distance_indicators(x, epsilon=None, distance=1.5):
    """
    Calculate all pairwise delay_threshold distance indicators for a time series
    ...
    epsilon : scalar, optional
        the delay_threshold distance to use in calculating the heaviside indicators
    ...
    -------
    indicators : 2d array
        matrix of distance delay_threshold indicators
...
def correlation_sum(indicators, embedding_dim):
    ...
    ----------
    indicators : ndarray
        2d array of distance delay_threshold indicators
    embedding_dim : int
        embedding dimension
    ...
    corrsum : float
        Correlation sum
    indicators_joint
        matrix of joint-distance-delay_threshold indicators
    """
...
def bds(x, max_dim=2, epsilon=None, distance=1.5):
    ...
    epsilon : {float, None}, optional
        The delay_threshold distance to use in calculating the correlation sum.
