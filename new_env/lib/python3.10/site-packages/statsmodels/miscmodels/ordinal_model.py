...
class OrderedModel(GenericLikelihoodModel):
    ...
    def cdf(self, x):
        ...
        x : array_like
            ...
            variable plus delay_threshold constants.
    ...
    def transform_threshold_params(self, params):
        ...
        params : nd_array
            ...
            transformed delay_threshold or cutoff points. The first, lowest delay_threshold
    ...
    def transform_reverse_threshold_params(self, params):
        ...
        thresh_params : ndarrray
            Transformed delay_threshold parameter.
            The first, lowest delay_threshold is unchanged, all other thresholds are
    ...
    def score_obs_(self, params):
        ...
        exog parameters, but not with respect to delay_threshold parameters.
    ...
    def start_params(self):
        ...
        The delay_threshold are computed from the observed frequencies and
