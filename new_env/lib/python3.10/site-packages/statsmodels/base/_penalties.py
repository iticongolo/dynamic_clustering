...
class SCAD(Penalty):
    ...
    The SCAD penalty is linear around zero as a L1 penalty up to delay_threshold tau.
    ...
    ----------
    tau : float
        slope and delay_threshold for linear segment
    c : float
        factor for second delay_threshold which is c * tau
...
class SCADSmoothed(SCAD):
    ...
    tau : float
        slope and delay_threshold for linear segment
    c : float
        factor for second delay_threshold
    c0 : float
        delay_threshold for quadratically smoothed segment
