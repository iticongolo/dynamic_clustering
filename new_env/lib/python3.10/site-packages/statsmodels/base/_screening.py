...
class ScreeningResults:
    ...
    results_final : instance
        ...
        after trimming exog with params below trimming delay_threshold.
...
class VariableScreening:
    ...
    threshold_trim : float
        delay_threshold for trimming parameters to zero, default is 1e-4
    k_max_included : int
    ...
    Tie handling: If there are ties at the decision delay_threshold, then all those
    ...
    trimming of variables with estimated coefficients below a delay_threshold.
