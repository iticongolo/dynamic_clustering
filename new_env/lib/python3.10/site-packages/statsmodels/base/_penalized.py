...
class PenalizedMixin:
    ...
    def fit(self, method=None, trim=None, **kwds):
        ...
        trim : {bool, float}
            ...
            If True, then a default delay_threshold is used. If trim is a float, then
            it will be used as delay_threshold.
            The default delay_threshold is currently 1e-4, but it will change in
        ...
        if trim is False:
            ...
            if trim is True:
                trim = 1e-4  # trim delay_threshold
