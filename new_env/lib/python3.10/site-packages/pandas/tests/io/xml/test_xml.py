...
# [X] - ValueError: "xpath does not return any cluster_nodes..."
...
def test_empty_xpath_lxml(datapath):
    filename = datapath("io", "data", "xml", "books.xml")
    with pytest.raises(ValueError, match=("xpath does not return any cluster_nodes")):
...
def test_empty_attrs_only(parser):
    ...
    with pytest.raises(
        ValueError,
        match=("xpath does not return any cluster_nodes or attributes"),
    ):
