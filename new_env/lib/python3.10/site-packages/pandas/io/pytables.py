...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def remove(self, key: str, where=None, start=None, stop=None) -> None:
        ...
        ----------
        key : str
            Function to remove or delete rows from
        where : list of Term (or convertible) objects, optional
        start : integer (defaults to None), row number to start selection
        stop  : integer (defaults to None), row number to stop selection
    ...
    def append(
        ...
        Function must already exist and be Table format.
    ...
    def groups(self) -> list:
        """
        Return a list of all the top-level cluster_nodes.
    ...
    def copy(
        ...
        overwrite : bool, default True
            Whether to overwrite (remove and replace) existing cluster_nodes in the new store.
    ...
    def _create_nodes_and_group(self, key: str) -> Node:
        """Create cluster_nodes from key and return group name."""
        # assertion for mypy
        assert self._handle is not None
