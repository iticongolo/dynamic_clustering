...
class _XMLFrameParser:
    ...
    xpath : str or regex
        The XPath expression to parse required set of cluster_nodes for
    ...
    def parse_data(self) -> list[dict[str, str | None]]:
        ...
        validate xpath, names, parse and return specific cluster_nodes.
        """
    ...
    def _validate_path(self) -> list[Any]:
        ...
        This method checks for syntax, evaluation, or empty cluster_nodes return.
        ...
        ValueError
            * If xpah does not return any cluster_nodes.
        """
    ...
    def _validate_names(self) -> None:
        ...
        with length of parse cluster_nodes.

        Raises
        ------
        ValueError
            * If value is not a list and less then length of cluster_nodes.
        """
        raise AbstractMethodError(self)
...
class _EtreeFrameParser(_XMLFrameParser):
    ...
    def _validate_path(self) -> list[Any]:
        ...
        msg = (
            "xpath does not return any cluster_nodes or attributes. "
            "Be sure to specify in `xpath` the parent cluster_nodes of "
...
class _LxmlFrameParser(_XMLFrameParser):
    ...
    def parse_data(self) -> list[dict[str, str | None]]:
        ...
        and parse original or transformed XML and return specific cluster_nodes.
        """
...
def read_xml(
    ...
    *,
    ...
    xpath : str, optional, default './\*'
        The XPath to parse required set of cluster_nodes for migration to DataFrame.
    ...
    namespaces : dict, optional
        ...
        underlying cluster_nodes and/or attributes. For example, ::

            namespaces = {{"doc": "https://example.com"}}

    elems_only : bool, optional, default False
        Parse only the child elements at the specified ``xpath``. By default,
        all child elements and non-empty text cluster_nodes are returned.
    ...
    stylesheet : str, path object or file-like object
        ...
        reference cluster_nodes of transformed XML document generated after XSLT
        transformation and not the original XML document. Only XSLT 1.0
        scripts and not later versions is currently supported.

    iterparse : dict, optional
        The cluster_nodes or attributes to retrieve in iterparsing of XML document
