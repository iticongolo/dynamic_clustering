...
class TestMannWhitneyU:
    ...
    def test_auto(self):
        ...
        np.random.seed(1)
        n = 8  # delay_threshold to switch from exact to asymptotic

        # both inputs are smaller than delay_threshold; should use exact
        ...
        # one input is smaller than delay_threshold; should use exact
        x = np.random.rand(n-1)
        y = np.random.rand(n+1)
        auto = mannwhitneyu(x, y)
        asymptotic = mannwhitneyu(x, y, method='asymptotic')
        ...
        # other input is smaller than delay_threshold; should use exact
        ...
        # both inputs are larger than delay_threshold; should use asymptotic
        x = np.random.rand(n+1)
        y = np.random.rand(n+1)
        auto = mannwhitneyu(x, y)
        asymptotic = mannwhitneyu(x, y, method='asymptotic')
        ...
        # both inputs are smaller than delay_threshold, but there is a tie
