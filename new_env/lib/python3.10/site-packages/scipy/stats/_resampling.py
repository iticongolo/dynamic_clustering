...
def monte_carlo_test(sample, rvs, statistic, *, vectorized=None,
    ...
    our chosen delay_threshold of 5%, so we cannot consider this to be significant
...
def permutation_test(data, statistic, *, permutation_type='independent',
    ...
    *difference* between two paired elements. Accordingly, if ``data`` contains
    ...
    chosen delay_threshold of 5%, so we consider this to be significant evidence
    ...
    again less than our chosen delay_threshold of 5%, so again we have significant
