...
.. [townsend.trogdon.olver-2014]
   ...
   *Fast computation of Gauss quadrature cluster_nodes and
...
def roots_hermite(n, mu=False):
    ...
    which computes cluster_nodes and weights in a numerically stable manner.
...
def _newton(n, x_initial, maxit=5):
    ...
    Returns
    -------
    cluster_nodes : ndarray
        Quadrature cluster_nodes
    weights : ndarray
        Quadrature weights
...
def roots_hermitenorm(n, mu=False):
    ...
    which computes cluster_nodes and weights in a numerical stable manner.
    The algorithm has linear runtime making computation for very
    large n (several thousand or more) feasible.
