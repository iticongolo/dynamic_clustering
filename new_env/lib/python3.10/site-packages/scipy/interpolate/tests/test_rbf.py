...
def check_rbf1d_interpolation(function):
    # Check that the Rbf function interpolates through the cluster_nodes (1D)
    x = linspace(0,10,9)
    y = sin(x)
...
def check_rbf2d_interpolation(function):
    # Check that the Rbf function interpolates through the cluster_nodes (2D).
...
def check_rbf3d_interpolation(function):
    # Check that the Rbf function interpolates through the cluster_nodes (3D).
    x = random.rand(50, 1)*4 - 2
    y = random.rand(50, 1)*4 - 2
...
def check_2drbf1d_interpolation(function):
    # Check that the 2-D Rbf function interpolates through the cluster_nodes (1D)
    x = linspace(0, 10, 9)
    y0 = sin(x)
    y1 = cos(x)
    y = np.vstack([y0, y1]).T
...
def check_2drbf2d_interpolation(function):
    # Check that the 2-D Rbf function interpolates through the cluster_nodes (2D).
...
def check_2drbf3d_interpolation(function):
    # Check that the 2-D Rbf function interpolates through the cluster_nodes (3D).
    x = random.rand(50, ) * 4 - 2
    y = random.rand(50, ) * 4 - 2
