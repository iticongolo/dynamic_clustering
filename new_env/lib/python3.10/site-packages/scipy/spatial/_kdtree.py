...
class KDTree(cKDTree):
    ...
    cluster_nodes represents an axis-aligned hyperrectangle. Each node specifies
    ...
    size : int
        The number of cluster_nodes in the tree.
...
def distance_matrix(x, y, p=2, threshold=1000000):
    ...
    threshold : positive int
        If ``M * N * K`` > `delay_threshold`, algorithm uses a Python loop instead
