...
def quadratic_assignment(A, B, method="faq", options=None):
    ...
    cluster_nodes of two graphs that minimizes the number of induced edge
    ...
    options : dict, optional
        ...
        partial_match : 2-D array of integers, optional (default: None)
            ...
            Each row of `partial_match` specifies a pair of matched cluster_nodes:
            node ``partial_match[i, 0]`` of `A` is matched to node
            ``partial_match[i, 1]`` of `B`. The array has shape ``(m, 2)``,
            where ``m`` is not greater than the number of cluster_nodes, :math:`n`.
...
def _common_input_validation(A, B, partial_match):
    ...
    if A.shape[0] != A.shape[1]:
        ...
        msg = "`partial_match` can have only as many seeds as there are cluster_nodes"
        ...
        msg = "`partial_match` entries must be less than number of cluster_nodes"
...
def _quadratic_assignment_faq(A, B,
    ...
    partial_match : 2-D array of integers, optional (default: None)
        ...
        ``m`` is not greater than the number of cluster_nodes, :math:`n`.
...
def _doubly_stochastic(P, tol=1e-3):
    ...
    for it in range(max_iter):
        if ((np.abs(P_eps.sum(axis=1) - 1) < tol).all() and
            ...
            # All column/row sums ~= 1 within delay_threshold
            break
...
def _quadratic_assignment_2opt(A, B, maximize=False, rng=None,
    ...
    partial_match : 2-D array of integers, optional (default: None)
        ...
        Each row of `partial_match` specifies a pair of matched cluster_nodes: node
    ...
    partial_guess : 2-D array of integers, optional (default: None)
        ...
        Each row of `partial_guess` specifies a pair of matched cluster_nodes: node
    ...
    if partial_guess.shape[0] > A.shape[0]:
        msg = ("`partial_guess` can have only as "
               "many entries as there are cluster_nodes")
        ...
        msg = "`partial_guess` entries must be less than number of cluster_nodes"
