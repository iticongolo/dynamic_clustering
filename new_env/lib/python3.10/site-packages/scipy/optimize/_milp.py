...
def milp(c, *, integrality=None, bounds=None, constraints=None, options=None):
    ...
    options : dict, optional
        ...
        node_limit : int, optional
            The maximum number of cluster_nodes (linear program relaxations) to solve
            before stopping. Default is no maximum number of cluster_nodes.
    ...
    res : OptimizeResult
        ...
        mip_node_count : int
            The number of subproblems or "cluster_nodes" solved by the MILP solver.
