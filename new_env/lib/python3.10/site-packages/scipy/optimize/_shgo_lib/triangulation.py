...
class Complex:
    def __init__(self, dim, func, func_args=(), symmetry=False, bounds=None,
        ...
        if symmetry:
            ...
            # self.status = self.C0()[-1].x
            # self.C0.status = self.status
        else:
            self.add_centroid()
    ...
    def add_centroid(self):
        ...
        # Connect status to all other vertices
        for v in self.C0():
    ...
    def sub_generate_cell(self, C_i, gen):
        ...
        # and the status of C_i as the origin
        ...
        for i, connections in enumerate(self.graph):
            ...
            if i == centroid_index:  # Break out of status
                break
